...
/**
 * Abstract moderate command representation for moderating commands that requires an online chatter.
 *
 * @author G4meMas0n
 ...
 */
public abstract class ModerateOnlineCommand extends ModerateCommand {

    protected static final int TARGET = 0;
    protected static final int CHANNEL = 1;

    protected ModerateOnlineCommand(@NotNull final String name,
                                    final int minArgs,
                                    final int maxArgs) {
    ...
    /**
     * Executes the moderate command for the given chatter and the given channel, returning its success.
     ...
     * @param channel the channel in that the chatter should be moderated.
