...
public final class ANSIColorTest {
    ...
    @Test
    public void unsupportedGetByBukkitColorTest() {
        assertNull(ANSIColor.getByBukkitColor(ChatColor.BOLD));
        assertNull(ANSIColor.getByBukkitColor(ChatColor.ITALIC));
        assertNull(ANSIColor.getByBukkitColor(ChatColor.UNDERLINE));
        assertNull(ANSIColor.getByBukkitColor(ChatColor.STRIKETHROUGH));
        assertNull(ANSIColor.getByBukkitColor(ChatColor.MAGIC));
    }
}
