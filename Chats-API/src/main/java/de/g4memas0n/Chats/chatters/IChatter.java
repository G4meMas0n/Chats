...
public interface IChatter {
     ...
     * @return the chatter of the last conversion or null if this chatter don't have a last conversion partner.
     */
    @Nullable IChatter getLastConversionPartner();

    /**
     * Sets the last conversion partner of this chatter.
     * @param chatter the last conversion partner.
     * @return true when the last conversion partner was changed as result of this call.
     * @throws IllegalArgumentException Thrown when the given chatter equals this chatter.
     */
    boolean setLastConversionPartner(@NotNull final IChatter chatter) throws IllegalArgumentException;
