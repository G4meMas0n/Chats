...
public interface IStorageFile extends Configuration {
     ...
     *
     * <p>All the values contained within this configuration will be removed, leaving only settings and defaults.</p>
     */
    void clear();
     ...
     *
     * <p>All the values contained within this configuration will be removed, leaving only settings and defaults, and
     * the new values will be loaded from the given file.</p>
     *
     * <p>If the base file can not be loaded for any reason, an exception will be thrown.</p>
     *
     ...
     *
     * <p>All the values contained within this configuration will be kept, but the base file will be deleted.</p>
     *
     * <p>If the base file can not be deleted for any reason, an exception will be thrown.</p>
     *
     ...
     *
     * <p>If the base file does not exist, it will be created. If already exists, it will be overwritten.</p>
     *
     * <p>If it can not be overwritten or created, an exception will be thrown.</p>
     *
     ...
     *
     * <p>If the ChatColor does not exist, this will return null.</p>
     *
     ...
     *
     * <p>If the ChatColor does not exist then the given default value will returned.</p>
     *
     * @param path The Path of the ChatColor to get.
     ...
     *
     * <p>If the Locale does not exist, this will return null.</p>
     *
     ...
     *
     * <p>If the Locale does not exist then the given default value will returned.</p>
     *
     * @param path The Path of the Locale to get.
     ...
     *
     * <p>If the UniqueId does not exist, this will return null.</p>
     *
     ...
     *
     * <p>If the UniqueId does not exist then the given default value will returned.</p>
     *
     * @param path The Path of the UniqueId to get.
     ...
     *
     * <p>If the List does not exist, this will return an empty List.</p>
     *
     ...
     *
     * <p>If the path exists but is not a ChatColor or if the path does not exist, this will return false.</p>
     *
     ...
     *
     * <p>If the path exists but is not a Locale or if the path does not exist, this will return false.</p>
     ...
     *
     * <p>If the path exists but is not a UniqueId or if the path does not exist, this will return false.</p>
     *
